...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gen-slate-btn1': 'h-12 px-4 py-2 bg-(slate op-15) hover:bg-op-20 rounded-sm w-6.3rem',
    'gen-slate-btn': 'h-12 px-4 py-2 bg-(slate op-15) hover:bg-op-20 rounded-sm w-3.6rem',
